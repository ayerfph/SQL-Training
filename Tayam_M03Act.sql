...
VALUES
	(1, 'Juan dela Cruz', 'Manila, Philippines', '+63 912 345 6789'),
	(2, 'Maria Santos', 'Cebu City, Philippines', '+63 923 456 7890'),
	(3, 'John Doe', 'New York, USA', '+1 555 123 4567'),
	(4, 'Jane Smith', 'London, UK', '+44 7700 900123'),
	(5, 'Hiroshi Tanaka', 'Tokyo, Japan', '+81 80 1234 5678'),
	(6, 'Pierre Dupont', 'Paris, France', '+33 6 12 34 56 78'),
	(7, 'Ahmed Ali', 'Dubai, UAE', '+971 50 987 6543'),
	(8, 'Carlos Garcia', 'Madrid, Spain', '+34 612 345 678'),
	(9, 'Emily Johnson', 'Sydney, Australia', '+61 412 345 678'),
	(10, 'Olga Petrov', 'Moscow, Russia', '+7 911 234 5678'),
	(11, 'Diego Ramirez', 'Buenos Aires, Argentina', '+54 9 11 2345 6789'),
	(12, 'Li Wei', 'Beijing, China', '+86 139 1234 5678'),
	(13, 'Rajesh Kumar', 'Mumbai, India', '+91 98765 43210'),
	(14, 'Fatima Hassan', 'Cairo, Egypt', '+20 100 123 4567'),
	(15, 'Anna Müller', 'Berlin, Germany', '+49 151 23456789'),
	(16, 'Jacob Williams', 'Toronto, Canada', '+1 647 123 4567'),
	(17, 'Sofia Rossi', 'Rome, Italy', '+39 320 123 4567'),
	(18, 'Lucas Silva', 'São Paulo, Brazil', '+55 11 91234 5678'),
	(19, 'Joon Park', 'Seoul, South Korea', '+82 10 1234 5678'),
	(20, 'Henry Thompson', 'Cape Town, South Africa', '+27 82 123 4567');
